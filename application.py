...
#         no_of_weekent_night = int(request.form['no_of_weekend_nights'])
...
#                               no_of_weekent_night, type_of_meal_plan, room_type_reserved]])
...
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 8080))  # Read PORT env var, default 8080
