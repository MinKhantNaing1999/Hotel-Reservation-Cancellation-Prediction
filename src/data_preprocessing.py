...
class DataProcessor:
    ...
    def select_features(self, df):
        try:
            ...
            top_features_important_df = feature_importance_df.sort_values(by='importance', ascending=False)

            num_features_to_select = self.config["data_processing"]["no_of_features"]

            top_10_features = top_features_important_df["feature"].head(num_features_to_select).values
    ...
    def process(self):
        try:
            ...
            raise CustomException("Error while preprocssing pipeline", e)
